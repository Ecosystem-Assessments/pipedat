...
doc_params <- function() {
  c(
    ...
    "@param name name of the dataset to use for storing purposes. A default value is provided, but it can be modified by the user, for example by a numeric and sequential identifier for a specific project.",
