...
#'
#' @return This function creates a new report in `pubs/pipedat/` using the template `inst/templates/report.Rmd` and all the data available in `data/pipedat/` and `data/grid/`.
#'
#' @export
#'
#' @examples
