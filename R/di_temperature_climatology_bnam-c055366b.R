#' @eval get_name("c055366b")
#'
#' @eval get_description("c055366b")
#'
#' @eval dp_params()
#' @eval di_params()
...
#'
#' @keywords pipeline_id: c055366b
#'
#' @examples
#' \dontrun{
#' di_c055366b()
#' }
di_c055366b <- function(bbox = NULL, bbox_crs = NULL, timespan = NULL, grid = NULL, ...) {
  ...
  if (!exist$integrated) {
    ...
    # =~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~=~-~= #
    # Formatted data
    name <- gsub("71944efd", "c055366b", name)
