...
# pipedat <a href='https://github.com/Environment-Health/pipedat'><img src='man/figures/logo.png' align="right" height="175" /></a>
...
The `pipedat()` function will export the raw and formatted data in the folder 'data/pipedat/'.
